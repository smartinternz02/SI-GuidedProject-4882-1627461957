...
API_KEY = "lqTN6ItBlEaqGU0E9RyxSPUH6xoCHBGMqoRIQB-rSSwy"
...
response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/cb362646-a468-480e-b06b-7d8cde029a36/predictions?version=2021-08-03', json=payload_scoring, headers={'Authorization': 'Bearer ' + mltoken})
